...
public class Vaccine extends JFrame {
	...
	public Vaccine() {
		...
		btnLogin.addActionListener(new ActionListener() {
			...
			if(checkvaccine.checklogin(name)){
					JOptionPane.showMessageDialog(Vaccine.this, " Vaccine Type: "+ checkvaccine.NumSlots(name));
				frame.dispose();
			}
				else{
					JOptionPane.showMessageDialog(Vaccine.this," Error!!! \n Aadhar number is invalid");
				textField.setText("");
				}
			}}
		);
