...
public class Menu extends JFrame {
	...
	public Menu() {
		...
		JLabel lblLibrarianSection = new JLabel("Covid Tracker ");
		lblLibrarianSection.setFont(new Font("Academy Engraved LET", Font.BOLD , 40));
		
		JButton btnBInfo = new JButton("User Details");
		...
		JButton btnSInfo = new JButton("Slots");
		btnSInfo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				SLOTSUI.main(new String[]{});
				frame.dispose();
			}
		});
		btnSInfo.setFont(new Font("Tahoma", Font.PLAIN, 13));
		
		JButton btnIssueBook = new JButton("Vaccination Type");
		btnIssueBook.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Vaccine.main(new String[]{});
				frame.dispose();
			}
		});
		btnIssueBook.setFont(new Font("Tahoma", Font.PLAIN, 13));
		
		JButton btnReturnBook = new JButton("Doses Taken");
		btnReturnBook.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				DosesUI.main(new String[]{});
				frame.dispose();
			}
		});
